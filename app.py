...
def check_password():
    ...
    def password_entered():
        """Controlla se utente e password corrispondono a quelli nel database (secrets)."""
    ...
    if "password_correct" not in st.session_state:
        ...
        st.error("⛔ Credenziali non valide o utenza disabilitata.")
        st.text_input("Username", key="username")
        st.text_input("Password", type="password", key="password")
...
# ==============================================================================
#                 INIZIO APP REALE (Visibile solo dopo Login)
# ==============================================================================
...
st.markdown("""
    ...
    /* === 2. NASCONDI MENU STREAMLIT (WHITE LABEL) === */
    #MainMenu {visibility: hidden;}
    header {visibility: hidden;}
    footer {visibility: hidden;}
...
with col_head2:
    ...
    st.caption(f"Utente connesso: {st.secrets['passwords'].get('user_display_name', 'Cliente')}")
